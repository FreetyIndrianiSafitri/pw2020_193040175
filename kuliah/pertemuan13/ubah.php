  ...
  <div class="row">
    <form action="" method="POST" class="col s12">
      ...
      <div class="row">
        ...
        <div class="input-field col s4 offset-s4">
          <input type="hidden" name="gambar_awal" value="<?= $m['gambar']; ?>">
          <input class="validate gambar" type="file" name="gambar" onchange="previewImage()">
          <label class="active">Gambar</label>
          <img class="img-preview" src="img/<?= $m['gambar']; ?>" width="100" style="display: block;">
          <button class="row col pink darken btn" type="submit" name="ubah">Ubah Data</button>
        </div>
      </div>
